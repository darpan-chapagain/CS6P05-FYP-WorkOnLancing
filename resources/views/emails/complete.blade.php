                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 190%;"><span
                                                                        style="font-size: 18px; line-height: 34.2px;"><strong><span
                                                                                style="line-height: 34.2px; font-size: 18px;">
                                                                                Hello {{ $details['fname'] }}
                                                                                {{ $details['lname'] }},
                                                                            </span></strong></span></p>
                                                                <p style="font-size: 14px; line-height: 190%;"><span
                                                                        style="font-size: 16px; line-height: 30.4px;">We
                                                                        are excited to let you know that your client has reviewd your work and assigned it completed!
                                                                        <strong>{{ $details['job'] }}</strong>.
                                                                    </span>
                                                                </p>
                                                                ...
                                                                <p style="font-size: 14px; line-height: 190%;"><span
                                                                        style="font-size: 16px; line-height: 30.4px;">We
                                                                        value the services that you provide through our
                                                                        application. You will get paid for this in a couple of buisness days!</span></p>
                                                                <p style="font-size: 14px; line-height: 190%;">&nbsp;
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 190%;"><span
                                                                        style="font-size: 16px; line-height: 30.4px;">Wishing
                                                                        you the very best to complete the
                                                                        job!&nbsp;</span></p>
                                                                <p style="font-size: 14px; line-height: 190%;">&nbsp;
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 190%;">
                                                                    <strong><span
                                                                            style="font-size: 16px; line-height: 30.4px;">WorkOnLancing</span></strong>
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 190%;">&nbsp;
                                                                </p>
                                                            </div>
