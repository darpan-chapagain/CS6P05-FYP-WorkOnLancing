                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 190%;"><span
                                                                        ...
                                                                        are excited to let you know that you have received a new job request!
                                                                ...
                                                                <p style="font-size: 14px; line-height: 190%;"><span
                                                                        style="font-size: 16px; line-height: 30.4px;">We
                                                                        value the job opportunities provide through our
                                                                        application. Please visit the application and see choose the right fit for your job!</span></p>
                                                                <p style="font-size: 14px; line-height: 190%;">&nbsp;
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 190%;"><span
                                                                        style="font-size: 16px; line-height: 30.4px;">Wishing
                                                                        you the very best!&nbsp;</span></p>
                                                                <p style="font-size: 14px; line-height: 190%;">&nbsp;
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 190%;">
                                                                    <strong><span
